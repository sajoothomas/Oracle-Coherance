...
@rem set java_home=D:\Oracle\jdk1.6.0_20
...
set java_opts="-Xms%memory% -Xmx%memory% -Dtangosol.coherence.ttl=0 -Dtangosol.coherence.cacheconfig=c:\Oracle\student\practices\Practice.04.03.solution\config\coherence-cache-config.xml"
