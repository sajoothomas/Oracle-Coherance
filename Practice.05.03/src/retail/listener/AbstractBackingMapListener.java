...
/**
 * <p>
 * The {@link AbstractBackingMapListener} provides a simplified base
 * implementation for backing {@link MapListener}s that provide real objects in
 * a map event (in normal Java representation) rather than those that use the
 * internal Coherence format (ie: {@link Binary}s.
 * </p>
 * 
 * <p>
 * Backing {@link MapListener}s are embeddable {@link MapListener}s that are
 * injected into Coherence Cache members (storage-enabled) for the purpose of
 * handling events directly in-process of the primary partitions (of distributed
 * schemes).
 * </p>
 * 
 * <p>
 * They are extremely useful for performing in-process processing of events
 * within Coherence itself.
 * </p>
 * 
...
public abstract class AbstractBackingMapListener implements MapListener {
	...
	/**
	 * <p>
	 * The {@link BackingMapManagerContext} that owns this listener. (all
	 * Backing {@link MapListener}s require a {@link BackingMapManagerContext})
	 * </p>
	 */
	 ...
	 * initialization and construction of the {@link BackingMapManager}.
	 * </p>
	 * 
	 * @param context
	 */
	...
	private Object getConvertedValue(Object internal) {
		//
		// TODO: Insert a implementation for this method
		// at a minimum it should call
		// context.getValueFromInternalConverter().convert(internal);
		// assuming internal is set and not null
		// and return the result
		return null;
	}

	/**
	 * Translate the old value to its original form from its internal serialized
	 * form
	 * 
	 * @param event
	 * @return the object in its original form
	...
	/**
	 * Translate the new value to its original form from its internal serialized
	 * form
	 * 
	 * @param event
	 * @return the object in its original form
