...
set SUPPORT="..\..\..\support"
set COHERENCE_CP=C:\Oracle\classpath;..\bin
...
set java_opts="-Xms%memory% -Xmx%memory% -Dtangosol.coherence.ttl=0 -Dtangosol.coherence.cacheconfig=c:\Oracle\student\practices\Practice.04.02.solution\config\coherence-cache-config.xml"
