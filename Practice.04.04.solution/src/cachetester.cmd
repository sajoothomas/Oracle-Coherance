...
set java_opts="-Xms%memory% -Xmx%memory% -Dtangosol.coherence.ttl=0 -Dtangosol.coherence.cacheconfig=c:\Oracle\student\practices\Practice.04.04.solution\config\coherence-cache-config.xml"
